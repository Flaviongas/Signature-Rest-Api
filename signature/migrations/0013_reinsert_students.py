...
class Migration(migrations.Migration):
    def InsertStudents(models, schema_editor):
        ...
        for student in data:
            ...
            added_student = Student.objects.create(
                first_name=first_name, second_name=second_name, last_name=last_name, second_last_name=second_last_name, rut=rut, dv=dv, major=found_major)
            # if found_major:
    ...
    dependencies = [
        ('signature', '0012_remove_major_students_student_major'),
    ]
